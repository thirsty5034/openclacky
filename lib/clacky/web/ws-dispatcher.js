...
WS.onEvent(ev => {
  ...
  switch (ev.type) {
    ...
    // (broadcast to every client, not just session subscribers). Used for
    // the optional completion chime + desktop notification; the toggle
    // gates it and the module decides whether the user is looking.
    case "task_finished":
