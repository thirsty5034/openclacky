...
const I18n = (() => {
  ...
  const TRANSLATIONS = {
    en: {
      ...
      "workspace.contextMenuHint": "Right-click a file or folder for more options",
      ...
      "projects.openError": "Failed to open project: ",
      "projects.newChat": "New chat in project",
      "projects.rename": "Rename project",
      "projects.renamePrompt": "Project name",
      "projects.renameError": "Failed to rename project: ",
      "projects.remove": "Remove project",
      "projects.removeConfirm": "Remove project \"{{name}}\" from the sidebar? Sessions and files are kept.",
      "projects.removeError": "Failed to remove project: ",
      "projects.emptySessions": "No chats yet — click + to start one",
      "projects.ungrouped": "Other sessions",
      "projects.showMore": "Show {{n}} more",
      ...
      "trash.sessionAutoCleanHint":   "The system keeps the most recent 200 sessions; older ones are moved here.",
      ...
      "header.owner.tooltip":     "Creator — click to open Extension & Creation",
    ...
    zh: {
      ...
      "workspace.contextMenuHint": "右键文件或文件夹显示更多菜单",
      ...
      "projects.open": "打开项目",
      "projects.openError": "打开项目失败：",
      "projects.newChat": "在项目中新建对话",
      "projects.rename": "重命名项目",
      "projects.renamePrompt": "项目名称",
      "projects.renameError": "重命名项目失败：",
      "projects.remove": "移除项目",
      "projects.removeConfirm": "从侧边栏移除项目「{{name}}」？会话和文件不会删除。",
      "projects.removeError": "移除项目失败：",
      "projects.emptySessions": "还没有对话 — 点 + 新建",
      "projects.ungrouped": "其他会话",
      "projects.showMore": "显示另外 {{n}} 个",
      ...
      "trash.sessionAutoCleanHint":   "系统自动保留最近 200 个会话，超出后自动移入此处。",
      ...
      "header.owner.tooltip":     "创作者 — 点击进入扩展与创作",
